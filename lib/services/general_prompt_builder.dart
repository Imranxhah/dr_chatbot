class GeneralPromptBuilder {
  static String buildInitialPrompt(String symptom) {
    return '''You are Dr Chatbot, an AI medical assistant specializing in general disease diagnosis.
A patient reports experiencing: $symptom
