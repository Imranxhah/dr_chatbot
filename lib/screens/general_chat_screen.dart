...
import '../services/general_prompt_builder.dart';
...
class GeneralChatScreen extends StatefulWidget {
  ...
  const GeneralChatScreen({super.key, required this.initialSymptom});
...
class _GeneralChatScreenState extends State<GeneralChatScreen> {
  ...
  void initState() {
    ...
    conversationHistory.add({
      'role': 'user',
      'content': 'Primary Symptom: ${widget.initialSymptom}',
    });
  ...
  String _buildPrompt() {
    if (conversationHistory.length == 1) {
      return GeneralPromptBuilder.buildInitialPrompt(widget.initialSymptom);
    } else {
      return GeneralPromptBuilder.buildFollowUpPrompt(conversationHistory);
    }
  }
